...
class LoadModelDemo {
  ...
  _Initialize() {
    ...
    // this._LoadAnimatedModelAndPlay(
    //     './resources/dancer', 'testloadAndAnimate_meshwitharmatures.fbx', 'testloadAndAnimate_armatures.fbx', new THREE.Vector3(0, -1.5, 5));
  ...
  _LoadModel() {
    ...
    loader.load('./resources/testloadgltfanimation.glb', (gltf) => {
